...
const CUSTOMIZATION_CFOMAPPING_RESOURCE_PLURAL =
  process.env.LOCAL === 'true'
    ? options?.CUSTOMIZATION_CFOMAPPING_RESOURCE_PLURAL
    : process.env.CUSTOMIZATION_CFOMAPPING_RESOURCE_PLURAL
const CUSTOMIZATION_CFOMAPPING_RESOURCE_NAME =
  process.env.LOCAL === 'true'
    ? options?.CUSTOMIZATION_CFOMAPPING_RESOURCE_NAME
    : process.env.CUSTOMIZATION_CFOMAPPING_RESOURCE_NAME
...
const CUSTOMIZATION_BREADCRUMBS_FALLBACK_ID =
  process.env.LOCAL === 'true'
    ? options?.CUSTOMIZATION_BREADCRUMBS_FALLBACK_ID
    : process.env.CUSTOMIZATION_BREADCRUMBS_FALLBACK_ID
const CUSTOMIZATION_CFO_FALLBACK_ID =
  process.env.LOCAL === 'true' ? options?.CUSTOMIZATION_CFO_FALLBACK_ID : process.env.CUSTOMIZATION_CFO_FALLBACK_ID
...
const PLUGIN_LOADING_INDICATOR_HEADER =
  process.env.LOCAL === 'true' ? options?.PLUGIN_LOADING_INDICATOR_HEADER : process.env.PLUGIN_LOADING_INDICATOR_HEADER
const PLUGIN_LOADING_INDICATOR_SIDEBAR =
  process.env.LOCAL === 'true'
    ? options?.PLUGIN_LOADING_INDICATOR_SIDEBAR
    : process.env.PLUGIN_LOADING_INDICATOR_SIDEBAR
const PLUGIN_LOADING_INDICATOR_NAVIGATION =
  process.env.LOCAL === 'true'
    ? options?.PLUGIN_LOADING_INDICATOR_NAVIGATION
    : process.env.PLUGIN_LOADING_INDICATOR_NAVIGATION
const PLUGIN_LOADING_INDICATOR_ROUTE =
  process.env.LOCAL === 'true' ? options?.PLUGIN_LOADING_INDICATOR_ROUTE : process.env.PLUGIN_LOADING_INDICATOR_ROUTE
...
const PLUGIN_LOADING_SPINNER_SIZE =
  process.env.LOCAL === 'true' ? options?.PLUGIN_LOADING_SPINNER_SIZE : process.env.PLUGIN_LOADING_SPINNER_SIZE
const PLUGIN_GLOBAL_SPINNER_SIZE =
  process.env.LOCAL === 'true' ? options?.PLUGIN_GLOBAL_SPINNER_SIZE : process.env.PLUGIN_GLOBAL_SPINNER_SIZE

const NAMESPACE_LABEL = process.env.LOCAL === 'true' ? options?.NAMESPACE_LABEL : process.env.NAMESPACE_LABEL
const NAMESPACE_PLACEHOLDER =
  process.env.LOCAL === 'true' ? options?.NAMESPACE_PLACEHOLDER : process.env.NAMESPACE_PLACEHOLDER
const NAMESPACE_ALL_LABEL =
  process.env.LOCAL === 'true' ? options?.NAMESPACE_ALL_LABEL : process.env.NAMESPACE_ALL_LABEL
const NAMESPACE_CHOOSE_PLACEHOLDER =
  process.env.LOCAL === 'true' ? options?.NAMESPACE_CHOOSE_PLACEHOLDER : process.env.NAMESPACE_CHOOSE_PLACEHOLDER
const NAMESPACE_SELECT_PLACEHOLDER =
  process.env.LOCAL === 'true' ? options?.NAMESPACE_SELECT_PLACEHOLDER : process.env.NAMESPACE_SELECT_PLACEHOLDER
  ...
  res.send(
    ...
    ${basePrefix ? `  BASEPREFIX: "${basePrefix}",` : ''}
      ...
      CUSTOMIZATION_CFOMAPPING_RESOURCE_PLURAL: ${
        JSON.stringify(CUSTOMIZATION_CFOMAPPING_RESOURCE_PLURAL) || '"check envs"'
      },
      CUSTOMIZATION_CFOMAPPING_RESOURCE_NAME: ${
        JSON.stringify(CUSTOMIZATION_CFOMAPPING_RESOURCE_NAME) || '"check envs"'
      },
      ${
      ...
      ${NAMESPACE_LABEL ? `NAMESPACE_LABEL: ${JSON.stringify(NAMESPACE_LABEL)},` : ''}
      ${NAMESPACE_PLACEHOLDER ? `NAMESPACE_PLACEHOLDER: ${JSON.stringify(NAMESPACE_PLACEHOLDER)},` : ''}
      ${NAMESPACE_ALL_LABEL ? `NAMESPACE_ALL_LABEL: ${JSON.stringify(NAMESPACE_ALL_LABEL)},` : ''}
      ${
        NAMESPACE_CHOOSE_PLACEHOLDER
          ? `NAMESPACE_CHOOSE_PLACEHOLDER: ${JSON.stringify(NAMESPACE_CHOOSE_PLACEHOLDER)},`
          : ''
      }
      ${
        NAMESPACE_SELECT_PLACEHOLDER
          ? `NAMESPACE_SELECT_PLACEHOLDER: ${JSON.stringify(NAMESPACE_SELECT_PLACEHOLDER)},`
          : ''
      }
      CUSTOMIZATION_SIDEBAR_FALLBACK_ID: ${JSON.stringify(CUSTOMIZATION_SIDEBAR_FALLBACK_ID) || '"check envs"'},
      CUSTOMIZATION_BREADCRUMBS_FALLBACK_ID: ${JSON.stringify(CUSTOMIZATION_BREADCRUMBS_FALLBACK_ID) || '"check envs"'},
      CUSTOMIZATION_CFO_FALLBACK_ID: ${JSON.stringify(CUSTOMIZATION_CFO_FALLBACK_ID) || '"check envs"'},
      ...
      PLUGIN_LOADING_INDICATOR_HEADER: ${JSON.stringify(PLUGIN_LOADING_INDICATOR_HEADER) || '"text"'},
      PLUGIN_LOADING_INDICATOR_SIDEBAR: ${JSON.stringify(PLUGIN_LOADING_INDICATOR_SIDEBAR) || '"text"'},
      PLUGIN_LOADING_INDICATOR_NAVIGATION: ${JSON.stringify(PLUGIN_LOADING_INDICATOR_NAVIGATION) || '"text"'},
      PLUGIN_LOADING_INDICATOR_ROUTE: ${JSON.stringify(PLUGIN_LOADING_INDICATOR_ROUTE) || '"text"'},
      PLUGIN_LOADING_SPINNER_MODE: ${JSON.stringify(PLUGIN_LOADING_SPINNER_MODE) || '"inline"'},
      ${PLUGIN_LOADING_SPINNER_SIZE ? `PLUGIN_LOADING_SPINNER_SIZE: "${PLUGIN_LOADING_SPINNER_SIZE}",` : ''}
      ${PLUGIN_GLOBAL_SPINNER_SIZE ? `PLUGIN_GLOBAL_SPINNER_SIZE: "${PLUGIN_GLOBAL_SPINNER_SIZE}"` : ''}
    }
    `,
  )
})
